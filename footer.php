<footer class="footer-layout-img">
                ...
                <div class="row">
                    ...
                    <div class="footer-content">
                                <!-- <div class="footer-logo">
                                    <a href="index.html"> <img class="img-fluid" src="../assets/images/logo/logo-white-1.png" alt="Footer Logo" /></a>
                                </div> -->
                                <P>Monday Merch is your full-service merch partner. We help you with product selection, design, production, warehousing, shipping, merch stores and more. Get free designs and quotes within 24 hours. Use our platform to manage designs company wide, see stock levels, manage shipments and automate merch activities. </p>
                                <ul class="pt-3">
                                    <li>
                            ...
                            <div>
                                <div class="footer-title d-md-block">
                                    ...
                                    <ul class="footer-details accordion-hidden">
                                        ...
                                        <li> <a class="nav" href="collection-left-sidebar.php">Shop</a></li>
                                        <li> <a class="nav" href="about-us.php">About Us</a></li>
                                        <li> <a class="nav" href="blog-left-sidebar.php">Blog</a></li>
                        ...
                        <div class="footer-content">
                            <div>
                                <div class="footer-title d-md-block">
                                    ...
                                    <ul class="footer-details accordion-hidden">
                                        <li> <a class="nav" href="product-bundle.php">Latest Shoes</a></li>
                                        <li> <a class="nav" href="variant-radio.php">Branded Jeans</a></li>
                                        <li> <a class="nav" href="product.php">New Jackets</a></li>
                                        <li> <a class="nav" href="variant-images.php">Colorful Hoodies</a></li>
                                        <li> <a class="nav" href="variant-dropdown.php">Best Perfume</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="footer-content">
                            <div>
                                <div class="footer-title d-md-block">
                                    <h5>Get Help</h5>
                                    <ul class="footer-details accordion-hidden">
                                        <li> <a class="nav" href="order-success.php">Your Orders</a></li>
                                        <li> <a class="nav" href="dashboard.php">Your Account</a></li>
                                        <li> <a class="nav" href="order-tracking.php">Track Orders</a></li>
                                        <li> <a class="nav" href="wishlist.php">Your Wishlist</a></li>
                                        <li> <a class="nav" href="faq.php">Shopping FAQs</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="footer-content">
                            <div>
                                <div class="footer-title d-md-block">
                                    <h5>My Account</h5>
                                    <ul class="footer-details accordion-hidden">
                                        <li> <a class="nav" href="dashboard.php">My Account</a></li>
                                        <li> <a class="nav" href="login.php">Login/Register</a></li>
                                        <li> <a class="nav" href="cart.php">Cart</a></li>
                                        <li> <a class="nav" href="order-success.php">Order History</a></li>
                                        <li> <a class="nav" href="faq.php">Delivery FAQs</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                ...
                                <div class="product-buttons"><a class="btn btn-solid" href="cart.php">Add to cart</a><a
                                        class="btn btn-solid" href="product.php">View detail</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="d-flex"><a href="#"><img class="img-fluid blur-up lazyload pro-img"
                                        ...
                                        <div class="add-card-content align-self-center text-center"><a href="#">
                                            ...
                                            <div class="buttons"><a class="view-cart btn btn-solid"
                                                    href="cart.php">Your cart</a><a class="checkout btn btn-solid"
                                                    href="check-out.php">Check out</a><a class="continue btn btn-solid"
                                                    href="index.php">Continue shopping</a></div>
    ...
    <div class="offcanvas offcanvas-end shopping-details" id="offcanvasRight" tabindex="-1"
        ...
        <div class="offcanvas-footer">
            ...
            <div class="cart-button"> <a class="btn btn_outline" href="cart.php"> View Cart</a><a class="btn btn_black"
                    href="check-out.php"> Checkout</a></div>
        </div>
    </div>
        ...
        <div class="offcanvas-body theme-scrollbar">
            <div class="container">
                ...
                <ul class="rapid-search">
                    <li> <a href="collection-left-sidebar.php"><i class="iconsax" data-icon="search-normal-2"></i>Jeans
                            Women</a></li>
                    <li> <a href="collection-left-sidebar.php"><i class="iconsax"
                    ...
                    <li> <a href="collection-left-sidebar.php"><i class="iconsax" data-icon="search-normal-2"></i>Shoes
                            Men</a></li>
                    <li> <a href="collection-left-sidebar.php"><i class="iconsax"
                ...
                <div class="row gy-4 ratio_square-2 preemptive-search">
                    <div class="col-xl-2 col-sm-4 col-6">
                        <div class="product-box-6">
                            <div class="img-wrapper">
                                <div class="product-image"><a href="product.php"> <img class="bg-img"
                    ...
                    <div class="col-xl-2 col-sm-4 col-6">
                        <div class="product-box-6">
                            ...
                            <div class="product-detail"><a href="product.php">
                                    <h6> Women's Stylish Top</h6>
                                </a>
                                <p>$120.00 </p>
                                <ul class="rating">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="newslwtter-content"><img class="img-fluid"
                                        src="../assets/images/other-img/text.png" alt="" />
                            ...
                            <div class="col-md-6 d-none d-lg-block">
                                <div class="newslwtter-img"> <img class="img-fluid"
                                        src="../assets/images/other-img/news-latter.png" alt="" /></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../assets/js/skeleton-loader.js"></script><!-- touchspin-->
...
<!-- Mirrored from themes.pixelstrap.net/katie/template/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 10:23:20 GMT -->
</html>