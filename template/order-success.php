            ...
            <div class="row gy-4">
                <div class="col-xl-8">
                    <div class="order-items sticky">
                        ...
                        <p>Order invoice has been send to your registered email account. double check your order details </p>
                    ...
                    <div class="summery-box">
                        ...
                        <div class="summery-content">
                            <ul>
                                ...
                                <li>
                                    <p>Shipping to </p><span>united kingdom</span></li>
                            </ul>
                            <ul>
                                <li>
                                    <p>shipping Costs</p><span>$0.00</span></li>
                                <li>
                                    <p>Total without VAT </p><span>$250.00</span></li>
                                <li>
                                    <p>Including 10% VAT </p><span>$25.00</span></li>
                                <li>
                                    <p>Discount Code </p><span>$-10.00</span></li>
                            </ul>
