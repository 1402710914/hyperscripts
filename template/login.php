                    ...
                    <div class="log-in-box">
                        ...
                        <div class="login-box">
                            <form class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating"><input class="form-control" id="floatingInputValue1" type="password" placeholder="Password" value="password"><label for="floatingInputValue1">Enter Your Password</label></div>
                                </div>
                                <div class="col-12">
                                    <div class="forgot-box">
                                        <div><input class="custom-checkbox me-2" id="category1" type="checkbox" name="text"><label for="category1">Remember me</label></div><a href="forget-password.php">Forgot Password?</a></div>
                                </div>
                                <div class="col-12"> <button class="btn login btn_black sm" type="submit" data-bs-dismiss="modal" aria-label="Close">Log In</button></div>
                            </form>
                        </div>
                        ...
                        <div class="sign-up-box">
                            <p>Don't have an account?</p><a href="sign-up.php">Sign Up</a></div>
                    </div>
                </div>
            </div>
        </div>
